...
params={
    ...
    'vmaxref':{'MBC_1':{'Fast':7.0,'Slow':0.076,'Necro':7.0, 'Py':0.08},
    ...
    'kC':{'MBC_1':{'Fast':0.008,'Slow':0.02,'Necro':0.01, 'Py':0.02},    # Michaelis-Menton half saturation parameter (g microbial biomass/g substrate)
    ...
    'eup':{'MBC_1':{'Fast':0.45,'Slow':0.25,'Necro':0.45, 'Py':0.1},     # Microbial carbon use efficiency for each substrate type (fast, slow, necromass). This amount is converted to biomass during decomposition, and the remainder is immediately respired as CO2
    ...
    # 'eup':{'MBC_1':{'Fast':0.4,'Slow':0.2,'Necro':0.4, 'Py':0.1},     # Set based on new CUE data
    #        'MBC_2':{'Fast':0.4,'Slow':0.4,'Necro':0.4, 'Py':0.1},     
    #        'MBC_3':{'Fast':0.5,'Slow':0.3,'Necro':0.6, 'Py':0.1},
    #        'MBC_4':{'Fast':0.5,'Slow':0.3,'Necro':0.6, 'Py':0.1}},
...
initvals['no burn Histosol']['MBC_1']=array(totalC_org_unburned*0.005) # Start with low initial microbial biomass. Assumes this simulation starts right after the fire
...
initvals['low sev burn Histosol']['MBC_1']=array(totalC_org_low_sev*0.0054) # Start with low initial microbial biomass. Assumes this simulation starts right after the fire
initvals['low sev burn Histosol']['MBC_2']=array(totalC_org_low_sev*0.0)
